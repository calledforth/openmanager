...
export const WIRE_COMMANDS = {
  ...
  resolveWorkspaceIcon: 'workspace.icon',
  listSessions: 'session.list',
  createSession: 'session.create',
  openSession: 'session.open',
  loadSessionHistory: 'session.history',
  renameSession: 'session.rename',
  deleteSession: 'session.delete',
  settleSession: 'session.settle',
...
export const WIRE_RESPONSES = {
  ...
  'workspace.icon': payload(ProofResponseSchemas['workspace.icon'].shape.payload),
  ...
  'session.history': payload(ProofResponseSchemas['session.history'].shape.payload),
  'session.rename': payload(z.object({ session: SessionSchema })),
  'session.delete': payload(z.null()),
  'session.settle': payload(ProofResponseSchemas['session.settle'].shape.payload),
  'session.acknowledge': payload(z.null()),
